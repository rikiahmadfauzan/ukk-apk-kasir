                    ...
                    <div class="col-span-12">
                        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <button data-tw-merge data-tw-toggle="modal" data-tw-target="#header-footer-modal-preview"
                                    data-tw-merge=""
                                    ...
                                    <form action="/create/kategori" method="post">
                                        ...
                                        <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                            <div class="col-span-12 sm:col-span-12">
                                                ...
                                                <input name="nama_kategori" data-tw-merge id="modal-form-1" type="text"
                            ...
                            <div class="box box--stacked flex flex-col">
                                ...
                                <div class="overflow-auto xl:overflow-visible">
                                    <table data-tw-merge="" class="w-full text-left border-b border-slate-200/60">
                                        ...
                                        <tbody>
                                            @foreach ($kategori_produk as $key => $item)
                                                            ...
                                                            <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                                <div class="col-span-12 sm:col-span-6">
                                                                    ...
                                                                    <input value="{{ $item->nama_kategori }}"
                                                                        name="nama_kategori" data-tw-merge
