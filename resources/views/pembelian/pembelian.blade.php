                                        ...
                                        <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                            <div class="col-span-12 sm:col-span-12">
                                                ...
                                                <div class="relative mx-auto">
                                                    ...
                                                    <input name="tanggal_beli" data-tw-merge type="text"
                                        ...
                                        <tbody>
                                                                    ...
                                                                    <div data-tw-merge=""
                                                                        ...
                                                                        <a data-tw-toggle="modal"
                                                                            ...
                                                                            class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item"><i
                                                                                ...
                                                                                class="stroke-[1] mr-2 h-4 w-4"></i>
                                                                            Edit</a>
                                                                        <a href="/pembelian/delete/{{ $item->id }}"
                                            ...
                                            <div data-tw-backdrop="" aria-hidden="true" tabindex="-1"
                                                ...
                                                <div data-tw-merge
                                                    ...
                                                    <form action="/pembelian/update/{{ $item->id }}" method="post">
                                                        @csrf
                                                        <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                            <div class="col-span-12 sm:col-span-12">
                                                                <label data-tw-merge for="modal-form-1"
                                                                ...
                                                                <div class="relative mx-auto">
                                                                    ...
                                                                    <input value="{{ $item->tanggal_beli }}" name="tanggal_beli" data-tw-merge
