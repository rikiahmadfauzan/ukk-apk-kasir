                    ...
                    <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        ...
                        <form class="pt-3" action="/create/pelanggan" method="post">
                            ...
                            <div class="form-group mt-3">
                                <input type="text" name="nama_pelanggan" class="form-control form-control-lg" id="nama"
                            ...
                            <div class="form-group mt-3">
                                <input type="number" name="no_telpon" class="form-control form-control-lg" id="no_telpon"
