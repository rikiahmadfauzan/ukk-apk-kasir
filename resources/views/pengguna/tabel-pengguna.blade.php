                    ...
                    <div class="col-span-12">
                        <div class="flex flex-col gap-y-3 md:h-10 md:flex-row md:items-center">
                            ...
                            <div class="flex flex-col gap-x-3 gap-y-2 sm:flex-row md:ml-auto">
                                <a href="/add/pengguna"> <button data-tw-merge=""
                                            ...
                                            @foreach ($pengguna as $key => $item)
                                                                    ...
                                                                    <div data-tw-merge=""
                                                                        ...
                                                                        <a data-tw-merge data-tw-toggle="modal"
                                                                            ...
                                                                            class="cursor-pointer flex items-center p-2 transition duration-300 ease-in-out rounded-md hover:bg-slate-200/60 dark:bg-darkmode-600 dark:hover:bg-darkmode-400 dropdown-item"><i
                                                                                ...
                                                                                class="stroke-[1] mr-2 h-4 w-4"></i>
                                                                            Edit</a>
                                                                        <a href="/pengguna/delete/{{ $item->id }}"
                                                ...
                                                <div data-tw-backdrop="" aria-hidden="true" tabindex="-1"
                                                    ...
                                                    <div data-tw-merge
                                                        ...
                                                        <form action="/pengguna/update/{{ $item->id }}"
                                                            method="post">
                                                            @csrf
                                                            <div data-tw-merge class="p-5 grid grid-cols-12 gap-4 gap-y-3">
                                                                <div class="col-span-12 sm:col-span-6">
                                                                    ...
                                                                    <input name="name" data-tw-merge id="modal-form-1"
                                                                ...
                                                                <div class="col-span-12 sm:col-span-6">
                                                                    ...
                                                                    <input name="username" data-tw-merge id="modal-form-2"
                                                                ...
                                                                <div class="col-span-12 sm:col-span-6">
                                                                    ...
                                                                    <input name="email" data-tw-merge id="modal-form-3"
                                                                ...
                                                                <div class="col-span-12 sm:col-span-6">
                                                                    ...
                                                                    <select name="level" data-tw-merge id="modal-form-6"
