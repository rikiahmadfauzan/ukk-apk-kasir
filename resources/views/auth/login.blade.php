            ...
            <div class="row w-100 mx-0 py-5">
                <div class="col-lg-4 mx-auto shadow">
                    <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        ...
                        @endif --}}
                        <form class="pt-3" action="/proses/login" method="post">
                            @csrf
                            <div class="form-group mt-3">
                                <input type="text" name="akun" class="form-control form-control-lg" id="akun"
                            ...
                            <div class="mt-3">
                                <button type="submit" class="btn btn-sm mb-3 btn-secondary col col-12">SIGN
                                    IN</button>
                            </div>
